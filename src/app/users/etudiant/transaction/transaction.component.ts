...
export class TransactionComponent {
  ...
  transfer(  codeSecurite: number,numeroCarteDestination: string,montant: number) {
    const transfererRequest = { codeSecurite,numeroCarteDestination,montant };
    ...
    Swal.fire({
      ...
      preConfirm: () => {
        ...
        if (securityCode) {
          ...
          return this.transfer( Number(securityCode1),Card,Number(montant1));
        } else {
          return null;
        }
      },
